...
const guardar = async (evento) => {
    ...
    const url ='/pdf/API/clientes/guardar';
    const config = {
        method : 'POST',
        body
    }
...
const eliminar = async (id) => {
    ...
    if (result.isConfirmed) {
        ...
        const url = `/pdf/API/clientes/eliminar`;
        const config = {
            method: 'POST',
            body,
        };
...
const buscar = async () => {
    ...
    const url =`/pdf/API/clientes/buscar?cliente_nombre=${cliente_nombre}`;
    const config = {
        method : 'GET',
    }
    ...
    try{
        ...
        console.log(console.log(tablaClientes.tBodies[0].innerHTML = ''));
        console.log(data);
